...
/// </summary>
public class LuaFunctionDoc(string moduleName, string functionName, string? description, LuaTypeInfo returnType, List<(string Name, LuaTypeInfo Type, string? Description)> parameters, string[]? examples, bool isMethod)
{
