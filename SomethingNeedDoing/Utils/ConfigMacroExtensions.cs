...
public static class ConfigMacroExtensions
{
    ...
    public static void Stop(this IMacro macro) => Service.MacroScheduler.StopMacro(macro.Id);
    public static void Pause(this IMacro macro) => Service.MacroScheduler.PauseMacro(macro.Id);
    public static void Resume(this IMacro macro) => Service.MacroScheduler.ResumeMacro(macro.Id);
