...
public class WorldState
{
    ...
    public unsafe long GetCurrentEorzeaTimestamp() => FFXIVClientStructs.FFXIV.Client.System.Framework.Framework.Instance()->ClientTime.EorzeaTime;
    public unsafe int GetCurrentEorzeaSecond() => DateTimeOffset.FromUnixTimeSeconds(FFXIVClientStructs.FFXIV.Client.System.Framework.Framework.Instance()->ClientTime.EorzeaTime).Second;
    public unsafe int GetCurrentEorzeaMinute() => DateTimeOffset.FromUnixTimeSeconds(FFXIVClientStructs.FFXIV.Client.System.Framework.Framework.Instance()->ClientTime.EorzeaTime).Minute;
    public unsafe int GetCurrentEorzeaHour() => DateTimeOffset.FromUnixTimeSeconds(FFXIVClientStructs.FFXIV.Client.System.Framework.Framework.Instance()->ClientTime.EorzeaTime).Hour;
    ...
    */
    ...
    public (float, float) GetAetheryteRawPos(uint aetheryteID)
    {
        ...
        return pos == null ? (0f, 0f) : (Misc.Utils.ConvertMapMarkerToRawPosition(pos.Value.X), Misc.Utils.ConvertMapMarkerToRawPosition(pos.Value.Y));
    }
}
