...
namespace SomethingNeedDoing.Old.Macros;
...
internal static class MacroParser
{
    ...
    public static MacroCommand ParseLine(string line)
    {
        ...
        return commandText switch
        {
            ...
            "/keyitem" => KeyItemCommand.Parse(line),
            ...
            "/target" when C.UseSNDTargeting => TargetCommand.Parse(line),
            "/targetenemy" when C.UseSNDTargeting => TargetEnemyCommand.Parse(line),
